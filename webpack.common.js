...
const PAGES = [
  {
    name: "index",
    description:
      "Studio Circule est un cabinet proposant plusieurs accompagnements : des soins énergétiques à distance pratiqués par magnétisme et radiesthésie.",
  },
  {
    name: "about",
    description:
  ...
  },
  {
    name: "temoignages",
    description:
      "Elles·ils ont testé la méthode Circule pour des soins énergétiques ou des séances de coaching et vous racontent.",
  },
  {
    name: "inspiration",
    description:
      "Ici, c’est mon journal. Une section plus personnelle où je poste mes pensées et mes découvertes. Un blog nouvelle génération que je suis ravie de vous partager !",
  },
  {
    name: "booking",
    description:
      "Réservez votre séance de coaching, de magnétisme et de soins énergétiques, nous vous accompagnons dans votre vie et vos projets.",
  },
];
const PAGE_TITLES = {
  index: "Accueil",
...
const urlifyTestimonial = (content) =>
  `temoignages/${urlify(content.testimonial_name)}.html`;
  ...
  return new HtmlWebpackPlugin({
    meta: {
      description: {
        ...
        content: content.testimonial_quote,
      },
    },
    endpoint: endpoint,
